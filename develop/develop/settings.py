...
ACTIVE_CAMPAIGN_URL = os.getenv("ACTIVE_CAMPAIGN_URL", None)
ACTIVE_CAMPAIGN_VERSION = os.getenv("ACTIVE_CAMPAIGN_VERSION", None)
ACTIVE_CAMPAIGN_KEY = os.getenv("ACTIVE_CAMPAIGN_KEY", None)